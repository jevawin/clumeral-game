...
**Short form proposed: sections 1, 3, 8, 11 only.** This is a rename with one
real decision in it (section 8). Sections 2, 4, 5, 6, 7, 9 and 10 have no
content: nothing is built, no maths, no state, no new module, no pixels, no
accessibility surface, no event. Awaiting Jamie's approval of the short form.
...
## 8. Copy & wording
Settled: pending · Ack: n/a — **Jamie's, and the only real decision here**
