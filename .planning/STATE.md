...
| 260722-tp3 | Roadmap reconciliation after the #262 deploy — closed 8 issues that shipped in #254/#258/#261 but were never closed (#81, #155, #194, #199, #202, #228, #249, #255), each verified in code on `main` first; 38 open → 30. Labelled #143/#151/#200/#201/#203 `roadmap` so the GitHub query and ROADMAP.md agree. Added #261 + a dated sweep log to ROADMAP.md, and #225 to _Next_ under a new Feedback heading. Root cause was release PRs using prose instead of `Closes #` — GIT-WORKFLOW.md now requires the closing references. PR [#263](https://github.com/jevawin/clumeral-game/pull/263) | 2026-07-22 | b7f5125 | [20260722-roadmap-cleanup-post-262](./quick/20260722-roadmap-cleanup-post-262/) |
